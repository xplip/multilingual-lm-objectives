...
class InputExample:
    """
    A single training/test example for part-of-speech tagging.
...
class InputFeatures:
    ...
    Property names are the same names as the corresponding inputs to a transformer-based model.
    """
...
if is_torch_available():
    ...
    class POSDataset(Dataset):
        """
        Pytorch Dataset for UD part-of-speech tagging.
        """
