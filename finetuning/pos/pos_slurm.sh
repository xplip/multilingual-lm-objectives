#!/bin/bash
#
#SBATCH --job-name=pos-finetuning
#SBATCH -p gpu --gres=gpu:a100:1
#SBATCH --ntasks=1 --cpus-per-task=10 --mem=64000M
...
for lr in "7e-4" "5e-4" "3e-4" "1e-4" "7e-5" "5e-5" "1e-5" "1e-6" ; do
  for seed in {1..3}; do
    ...
    python run_pos.py \
      ...
      --retrieval_data_dir=../../data/tedtalks2020 \
      --retrieval_max_examples=3500 \
      --languages=fr,it,zh,ja,pt,th,tr \
